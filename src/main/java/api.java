...
public class api {
    ...
    public void start() {
        ...
        System.out.println("Escriu /ajuda per veure les opcions");
        System.out.println("Escriu /cletus per sortir");
        ...
        while (true) {
            ...
            if (input.equalsIgnoreCase("/cletus")) break;
            ...
            if (input.startsWith("/rol ")) {
                String role = input.substring(6).trim();
                setSystemRole(role);
                System.out.println("[SISTEMA] Rol canviat a : " + role);
                continue;
            }
    ...
    private void printHelp() {
        System.out.println("""
            ...
            /cletus           - Finalitza la sessió
            /rol <text        - Defineix el rol del sistema
            /model <nom       - Canvia el model d'OpenAI utilitzat
            Exemples:
            /rol  Ets un alumne de programació de DAM.
            /model gpt-3.5-turbo
            """);
    }
